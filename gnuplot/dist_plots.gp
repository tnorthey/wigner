...
LMARGIN = "set lmargin at screen 0.15; set rmargin at screen 0.40"
RMARGIN = "set lmargin at screen 0.40; set rmargin at screen 0.65"
...
set output "dist_plots.png"

YBOT = 0.5
YTOP = 2.9
set yrange [YBOT : YTOP]
set xrange [YBOT : YTOP]
...
#set logscale x 10
#set logscale y 10
plot "< paste ../distances/r16.dat ../distances/r12.dat" u 1:2  w p ls 1
# --- GRAPH b
@MMARGIN; @LMARGIN
@NOXTICS; @YTICS
set ylabel "r_{23} (Å)"
@NOKEY
plot "< paste ../distances/r16.dat ../distances/r23.dat" u 1:2  w p ls 1
set label 1 '' @POS
# --- GRAPH c
@BMARGIN; @LMARGIN
@XTICS; @YTICS
...
@NOKEY
set label 1 '' @POS
plot "< paste ../distances/r16.dat ../distances/r34.dat" u 1:2  w p ls 1
...
@NOKEY
set label 1 '' @POS
plot "< paste ../distances/r16.dat ../distances/r45.dat" u 1:2  w p ls 1
...
@NOKEY
set label 1 '' @POS
plot "< paste ../distances/r16.dat ../distances/r56.dat" u 1:2  w p ls 1
